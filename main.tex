...
\title{知識選択型転移強化学習を用いた自律型移動ロボットにおける動的障害物の回避
}
\etitle{Dynamic Obstacle Avoidance in Autonomous Mobile Robots Using Knowledge-Selective Transfer Reinforcement Learning}
\affiliation{東京電機大学 工学部 情報通信工学科}
\supervisor{准教授　河野 仁}
\studentid{20EC060}
\author{須賀　哉斗}
\begin{document}
