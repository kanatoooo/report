...
\begin{figure}[h]
	\centering
	\includegraphics[width=120mm]{./chap4/chap4_fig/POLICY}
	\caption{知識構造の概念図}
	\label{POLICY}
\end{figure}
\clearpage
...
\end{figure}
\subsection{実験結果}
Fig.に障害物を右に回避した時の比較動合成画像を，Fig.に障害物を左に回避した時の比較動合成画像を示す．Fig.およびFig.より知識を選択しながら障害物を回避することに成功した．また，Fig.\ref{POLICY}から，ステップ数においての知識番号選択のグラフをFig.\ref{migikaihi}とFig.\ref{hidarikaihi}に示す．
\begin{figure}[h]
	\centering
