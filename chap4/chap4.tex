...
\end{figure}
Fig.\ref{SAP-net_sim}より，知識（行動価値関数）を保持した状態なので，強化学習実験とは違ってより少ない行動でゴールしていることがわかる．Fig.\ref{SAP-net_reward}より，Webotsでのバグが生じたものの，ほぼ正の値に収束していることがわかる．また，障害物を2つ配置した場合の行動も検証したので，1エピソードだけ実行して，その時の移動軌跡をFig.\ref{SAP-net_kiseki}に示す．\\
\begin{figure}[h]
	\centering
